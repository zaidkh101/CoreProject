...
namespace CoreProjectRemasterd.Controllers
{
    public class OffersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OfferID,OfferTitle,OfferDescription,OfferImage")] Offer offer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OfferID,OfferTitle,OfferDescription,OfferImage")] Offer offer)
        {
            if (id != offer.OfferID)
            {
                return NotFound();
